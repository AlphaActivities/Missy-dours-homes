          ...
          <div className="text-center md:text-left max-w-4xl">
            ...
            <LuxFadeIn delay={0.1}>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-[1.1]">
                <span className="block text-white">GUIDING NORTH TEXAS</span>
                <span className="block text-[#F5E6C8]">BUYERS & SELLERS</span>
                <span className="block text-white">WITH TRUSTED REAL ESTATE EXPERTISE</span>
              </h1>
            </LuxFadeIn>
