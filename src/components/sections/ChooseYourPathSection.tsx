...
export default function ChooseYourPathSection({
  ...
  return (
    <section
      id="choose-your-path"
      className="lux-section bg-transparent text-white py-24 md:py-32 lg:py-36 relative"
    >
      {/* Gold radial glow background */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(circle at center, rgba(196, 164, 106, 0.5) 0%, rgba(196, 164, 106, 0.3) 25%, rgba(196, 164, 106, 0.1) 50%, transparent 100%)',
        }}
      />

      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 space-y-10 relative z-10">
